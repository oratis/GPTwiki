...
export const backlog: BacklogTopic[] = [
  ...
  { topicKey: 'password-manager-worth-it', question: "Is a password manager actually safe to use, and which type should I choose?", cluster: 'digital-security', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'air-fryer-vs-convection-oven', question: "Is an air fryer just a small convection oven, or is there a real cooking difference worth paying for?", cluster: 'cooking-science', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'led-vs-incandescent-math', question: "How much money do I actually save by switching all my bulbs to LED?", cluster: 'home-energy', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'freelance-vs-full-time', question: "Should I go freelance or stay full-time employed — how do I weigh the real trade-offs?", cluster: 'careers-work', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'monitor-resolution-guide', question: "Do I actually need a 4K monitor, or is 1440p the better practical choice for most people?", cluster: 'digital-buying', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'sleep-debt-real', question: "Is sleep debt a real thing, and can you actually recover from it by sleeping in on weekends?", cluster: 'everyday-science', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'note-taking-methods', question: "Which note-taking method is most effective for actually retaining and using what you learn?", cluster: 'learning-productivity', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'credit-score-factors', question: "What actually affects my credit score the most, and which habits move the needle fastest?", cluster: 'personal-finance', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'maillard-vs-caramelization', question: "What is the difference between the Maillard reaction and caramelization, and why does it matter for how I cook?", cluster: 'cooking-science', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'term-vs-whole-life-insurance', question: "Should I buy term life insurance or whole life insurance, and is whole life ever actually worth the extra cost?", cluster: 'personal-finance', locales: ['en', 'zh'], status: 'drafted' },
  { topicKey: 'cold-water-vs-hot-water-washing', question: "Should I wash my clothes in cold or hot water, and does it really make a difference for cleaning and fabric care?", cluster: 'cooking-science', locales: ['en', 'zh'], status: 'drafted' },
  ...
  { topicKey: 'solar-panel-payback', question: "How long does it actually take for home solar panels to pay for themselves?", cluster: 'home-energy', locales: ['en', 'zh'], status: 'drafted' },
